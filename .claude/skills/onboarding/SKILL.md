...
- **Do not write one client's data into another's files.** Reading across
  them is fine - the person you work for owns all of them - but a result
  belongs to the client who paid for it: it does not become this client's
  proof unless they said it may be named.
